...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibmlja3l0cnVuZzEyMyIsImEiOiJja3JzdHRyZ3g5a3NkMnZtZmgzcm5tNXp2In0.7Zr8nJDtee0mKcKKu4Gmcw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Something when wrong 😓');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updatePassword' : 'http://127.0.0.1:3000/api/v1/users/updateInfo';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Update ".concat(type, " successful \u2714"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var formUpdateInfo = document.querySelector('.form-user-info');
...
if (formUpdateInfo) {
  formUpdateInfo.addEventListener('submit', function (e) {
    e.preventDefault();
...
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./mapbox":"mapbox.js","./login":"login.js","./logout":"logout.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
